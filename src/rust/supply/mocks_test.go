...
// MockCommandExt is a mock of CommandExt interface
type MockCommandExt struct {
	ctrl     *gomock.Controller
	recorder *MockCommandExtMockRecorder
}

// MockCommandExtMockRecorder is the mock recorder for MockCommandExt
type MockCommandExtMockRecorder struct {
	mock *MockCommandExt
}

// NewMockCommandExt creates a new mock instance
func NewMockCommandExt(ctrl *gomock.Controller) *MockCommandExt {
	mock := &MockCommandExt{ctrl: ctrl}
	mock.recorder = &MockCommandExtMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockCommandExt) EXPECT() *MockCommandExtMockRecorder {
	return m.recorder
}

// ExecuteWithPipe mocks base method
func (m *MockCommandExt) ExecuteWithPipe(arg0 string, arg1, arg2 io.Writer, arg3, arg4 string) error {
	ret := m.ctrl.Call(m, "ExecuteWithPipe", arg0, arg1, arg2, arg3, arg4)
	ret0, _ := ret[0].(error)
	return ret0
}

// ExecuteWithPipe indicates an expected call of ExecuteWithPipe
func (mr *MockCommandExtMockRecorder) ExecuteWithPipe(arg0, arg1, arg2, arg3, arg4 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ExecuteWithPipe", reflect.TypeOf((*MockCommandExt)(nil).ExecuteWithPipe), arg0, arg1, arg2, arg3, arg4)
}
